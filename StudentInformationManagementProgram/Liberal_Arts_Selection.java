...
public class Liberal_Arts_Selection extends JFrame
{
	Data_Base D;
	
	Liberal_Arts_Selection(Data_Base D)
	{
		this.D = D;
		int num=90;
		int i=0;

		setTitle("Information Of Liberal Arts Selection");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		Container c = getContentPane();
		c.setLayout(null);

		JLabel la = new JLabel("<< Information Of Liberal Arts Selection >>");
		...
		for(i=0; i<D.L_total; i++)
		{
			...
			if(D.FIELD.get(i).equals("Liberal Arts Selection"))
			{
