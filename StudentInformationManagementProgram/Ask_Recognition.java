...
public class Ask_Recognition extends JFrame
{
	Data_Base D;

	Ask_Recognition(Data_Base D)
	{
		this.D = D;

		setTitle("Ask Recognition");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		Container c = getContentPane();
		c.setLayout(null);

		JLabel la = new JLabel("<< Ask Recognition >>");
