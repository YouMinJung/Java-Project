...
public class Major_Required extends JFrame
{
	Data_Base D;
	
	Major_Required(Data_Base D)
	{
		this.D = D;
		...
		setTitle("Information Of Major Required");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

		Container c = getContentPane();
		c.setLayout(null);

		JLabel la = new JLabel("<< Information Of Major Required >>");
		...
		for(i=0; i<D.L_total; i++)
		{
			...
			if(D.FIELD.get(i).equals("Major Required"))
			{
